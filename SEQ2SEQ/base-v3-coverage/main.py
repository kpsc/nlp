...
def train():
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(1, 20):
            cov_wt = 0.0 if epoch < 5 else 0.5
            ...
            for _ in bar:
                ...
                output = model.train_step(sess, source, source_len, target, target_len, decoder_input, cov_wt)
            ...
            output = model.train_step(sess, src, s_len, tgt, t_len, dec, optim=False)
